 ...
 * [문제명] 구명보트
 * [풀이시간] 18분 / 37분 / 11분
 * [한줄평] 문제를 대충 읽고 잘못 풀어서 시간이 좀 더 걸렸지만 아주 쉬운 그리디 문제였다.
 * / 어떻게 해야 최솟값을 구할 수 있을지 고민하다가 처음보다 푸는데 오래걸렸다.
 * / 정렬을 하고 투포인터로 푸는 쉬운 문제였다.
 * 1_v1. 투포인터, 그리디(성공)
 * [풀이] 그리디 문제는 정렬이 핵심이다. 오름차순 정렬 후 왼쪽, 오른쪽 포인터 2개를 사용해 최솟값을 구할 수 있다.
 * [구명보트를 최소한으로 사용하는 방법]
